...
/**
 * Controller mapper
 * looking for ctrl class by name (name + 'Controller')
 * @param name {String}
 * @returns {dMVC.Controller}
 */
dMVC.getController = function(name) {
    return new dMVC[name + 'Controller']();
};
...
dMVC.Controller = Object.subClass({
     ...
     * @param socket {Object} socket.evtType must match this method name
     * @param msg {Object} message
     */
    processRequest: function(socket, msg/*req, res, next*/) {
        var command = this[msg.evtType](socket, msg);
        //socket.json.send({'event': 'messageReceived', message: msg});   //msg.cid  msg.emitter...
    }
...
io.sockets.on('connection', function (socket) {
    ...
    socket.on('message', function (msg) {
        var controller = dMVC.getController(msg.emitter);
        controller.processRequest(socket, msg);
    ...
    socket.on('disconnect', function() {
        //TODO: some useless data cleanup?
        /*var time = (new Date).toLocaleTimeString();
